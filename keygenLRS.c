/* To compile, cd to the base directory, type in gcc -g -Wall -I /usr/local/include -L/usr/local/lib/ -l m4rie -o test  keygenLRS.c basic.c keygenLRStest.c */
...
{
	//printf("o2 = %d, D21 = %d\n", o2, D21);
	matrix_B2 = malloc(o2*(sizeof(int*)));
	int i,j;

	for(i = 0; i < o2; i++)
	{
		matrix_B2[i] = malloc(D21*sizeof(int));
	}
	...
	for(i = 0; i < o2; i++)
	{
		for(j = 1; j < D21; j++)
		{
			matrix_B2[i][j] = mulTable(Gamma[i],matrix_B2[i][j-1]);
		}
	}
}
...
void generate_matrix_MS_inverse()
{
	...
	S_INV = mzed_invert_newton_john(S_INV, S);
	//printf("inverse calculation finished.\n");

	matrix_MS_inverse = malloc(m*sizeof(int*));
	//printf("inverse initialized.\n");
...
void generate_matrix_MS22_inverse()
{
	...
	S22_INV = mzed_invert_newton_john(S22_INV, S22);
...
void generate_matrix_MT_inverse()
{
	...
	T_INV =  mzed_invert_newton_john(T_INV, T);
	matrix_MT_inverse = malloc(n*sizeof(int*));

	for(i = 0; i < n; i++)
	{
		matrix_MT_inverse[i] = malloc((n+1)*sizeof(int*));
	}
	for(i = 0; i < n; i++)
	{
		for(j = 0; j < n; j++)
...
void generate_matrix_A_inverse_T()
{
	...
	A_INV = mzed_invert_newton_john(A_INV, A);
...
void generate_matrix_A11_inverse_T()
{
	...
	A11_INV = mzed_invert_newton_john(A11_INV, A11);
	matrix_A11_inverse_T = malloc(D1*sizeof(int*));

	for(i = 0; i < D1; i++)
	{
		matrix_A11_inverse_T[i] = malloc(D1*sizeof(int));
	}
	for(i = 0; i < D1; i++)
	{
		for(j = 0; j < D1; j++)
...
void generate_matrix_Q11_Q21()
{
	...
	for(i = 0; i < o1; i++)
	{
		matrix_Q11[i] = malloc(D1*sizeof(int));
	}
...
void generate_matrix_Q12()
{
	...
	for(i = 0; i < o1; i++)
	{
		matrix_Q12[i] = malloc(D21*sizeof(int));
	}
...
void generate_matrix_MF()
{
	...
	for(i = 0; i < o1; i++)
	{
		matrix_MF[i] = malloc(col_1*sizeof(int));
	}
	for(i = o1; i < m; i++)
	{
		matrix_MF[i] = malloc(col_2*sizeof(int));
	}
...
void generate_privatekey()
{
	...
	generate_matrix_B1();
	//print_matrix(m, D1, matrix_B1);
	generate_matrix_B2();
	//print_matrix(o2, D21, matrix_B2);
	/* free gamma right after generating B1 and B2. */
	free_gamma();

	generate_matrix_MS();
	printf("Printting matrix_MS.......\n");
	print_matrix(m, m+1, matrix_MS);
	printf("Finish printing.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");
	//printf("print matrix MS :\n");
	//print_matrix(m, m+1, matrix_MS);
	//printf("start generating matrix inverse....\n");
	generate_matrix_MS_inverse();
	//printf("generating finish.\n");
	printf("printing matrix MS inverse........\n");
	print_matrix(m, m+1, matrix_MS_inverse);
	printf("Finish printing.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");
	...
	printf("Printing matrix MS22 inverse.......\n");
	print_matrix(o2, o2, matrix_MS22_inverse);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix MT.......\n");
	generate_matrix_MT();
	print_matrix(n+1, n+1, matrix_MT);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");
	...
	printf("Printing matrix MT inverse.......\n");
	print_matrix(n, n+1, matrix_MT_inverse);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");
	...
	generate_matrix_A();
	print_matrix(D2, D2, matrix_A);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix A inverse.......\n");
	generate_matrix_A_inverse_T();
	print_matrix(D2, D2, matrix_A_inverse_T);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix A11 inverse.......\n");
	generate_matrix_A11_inverse_T();
	print_matrix(D1, D1, matrix_A11_inverse_T);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix Q11.......\n");
	generate_matrix_Q11_Q21();
	print_matrix(o1, D1, matrix_Q11);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix Q21.......\n");
	//generate_matrix_Q11_Q21();
	print_matrix(o2, D1, matrix_Q21);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix F1.......\n");
	generate_matrix_F1();
	print_matrix(o1, D1, matrix_F1);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix Q12.......\n");
	generate_matrix_Q12();
	print_matrix(o1, D21, matrix_Q12);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix Q22.......\n");
	generate_matrix_Q22();
	print_matrix(o2, D21, matrix_Q22);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");

	printf("Printing matrix F2.......\n");
	generate_matrix_F2();
	print_matrix(o2, D2, matrix_F2);
	printf("printing finish.\n");
	printf("\n");
	printf("-------------------------------------------\n");
	printf("\n");
	
	printf("Printing matrix MF.......\n");
	generate_matrix_MF();
	//print_matrix()
	printf("printing finish.\n");
	printf("\n");
...
{
	free_matrix(matrix_B1, m);
	free_matrix(matrix_B2, o2);
	free_matrix(matrix_MS, m);
	free_matrix(matrix_MS_inverse, m);
	free_matrix(matrix_MS22_inverse, o2);
	free_matrix(matrix_MT, n+1);
	free_matrix(matrix_MT_inverse, n);
	free_matrix(matrix_A, D2);
	free_matrix(matrix_A_inverse_T, D2);
	free_matrix(matrix_A11_inverse_T, D1);
	free_matrix(matrix_Q11, o1);
	free_matrix(matrix_Q21, o2);
	free_matrix(matrix_F1, o1);
	free_matrix(matrix_Q12, o1);
	free_matrix(matrix_Q22, o2);
	free_matrix(matrix_F2, o2);
	free_matrix(matrix_MF, m);
}
...
void generate_matrix_MQ()
{
	...
	//printf("memory allocation finish.\n");
	//printf("v1 = %d, v2 = %d, o1 = %d\n", v1, v2, o1);
...
{
	free_3d_array(matrix_MQ, m, n+1);
	free_3d_array(matrix_MFT, m, n+1);
	free_matrix(matrix_MFK, m);
	free_matrix(matrix_MPK, m);
	free_3d_array(matrix_PK, m, n+1);
}
...
void print_key()
{
	...
	for(i = 0; i < m; i++)
	{
		...
		for(j = 0; j < ((n)*(n+1))/2; j++)
		{
			fprintf(fp, "%d%s%d%s%d\t", matrix_MPK[i][j], "*m", k, "*m",l);
