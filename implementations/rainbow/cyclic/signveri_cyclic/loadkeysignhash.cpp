...
{
  string line;
  ifstream myfile ("/home/ishtiaq/rainbow/data/PublicKeycyclic.txt");
  if (myfile.is_open())
  {
	getline (myfile,line);
		...
		cout<<"Error Number of Oil Variables(o1) not present\n";
    	o1= atoi(line.c_str());
	...
	getline (myfile,line);
		...
		cout<<"Error Number of Oil Variables(o2) not present\n";
    	o2= atoi(line.c_str());
	...
	getline (myfile,line);
		...
		cout<<"Error Number of Vinegar Variables(v1) not present\n";
    	v1= atoi(line.c_str());
	...
	getline (myfile,line);
		...
		cout<<"Error Number of Vinegar Variables(v2) not present\n";
    	v2= atoi(line.c_str());	
 ...
 ifstream myfile1 ("/home/ishtiaq/rainbow/data/SignatureandHash_cyclic.txt");
  if (myfile1.is_open())
  {
